...
<body>
    <section>
    <button><a href="alta_cliente1.html">Crear Cliente </a></button>
    </section>
    <?php
    ?>
    <table>
        ...
        <tbody>
            ...
            while ($datos = mysqli_fetch_array($resultado)) {
                ...
                echo ' <a id="boton1" class="mbri-trash mbr-iconfont-btn" href="baja_cliente.php?ID_CLIENTE='.$id.'"title="borrar
                 cliente" onClick="confirm("borrar el menu?")">
                ...
                echo '<a id="boton2" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="modificar_cliente1.php?ID_CLIENTE='.$id.'"
