...
<body>
    ...
    ?>
    <section>
    <?php echo'<button> <a href="alta_impuestos1.html"> Crear Impuesto </a></button>'?>
    </section>
    <table>
        ...
        <tbody>
            ...
            $sql = "SELECT * from IMPUESTO order by ID_IMPUESTO desc";
            ...
            while ($datos = mysqli_fetch_array($resultado)) {
                ...
                echo ' <a id="boton1" class="mbri-trash mbr-iconfont-btn" href="baja_impuestos.php?ID_IMPUESTO='.$id.'"title="borrar
                 componente" onClick="confirm("borrar el impuesto?")">
                ...
                echo '<a id="boton2" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="modificar_impuestos1.php?ID_IMPUESTO='.$id.'"
