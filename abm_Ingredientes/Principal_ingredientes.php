...
<head>
    ...
    <title>Principal ingredientes</title>
...
<body>
    <section>
    <?php echo'<button> <a href="alta_ingrediente1.html"> Crear ingrediente </a></button>'?>
    </section>
    <?php
    ?>
    <table>
        ...
        <tbody>
            ...
            while ($datos = mysqli_fetch_array($resultado)) {
                ...
                echo ' <a id="boton1" class="mbri-trash mbr-iconfont-btn" href="baja_ingredientes.php?ID_INGREDIENTES='.$id.'"title="borrar
                 ingrediente" onClick="confirm("borrar el ingrediente?")">
                ...
                echo '<a id="boton2" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="modificar_ingredientes1.php?ID_INGREDIENTES='.$id.'"
