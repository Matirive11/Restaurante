...
<body>
<section>
<?php echo'<button> <a href="alta_menu1.php"> Crear Menu </a></button>'?>
</section>
    <table  style="border:solid 2px #003366">
        ...
        <tbody>
            ...
            echo "<td>";
                ...
                menu" onClick="confirm("borrar el menu?")">
               ...
               echo '<a id="boton2" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="modificar_menu1.php?ID_MENU='.$id.'"
