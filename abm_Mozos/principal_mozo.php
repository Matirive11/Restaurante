...
<body>
    ...
    ?>
    <section>
    <button><a href="alta_mozo1.html">Crear Mozo </a></button>
    </section>
    <table>
        ...
        <tbody>
            ...
            $sql = "SELECT * from MOZO order by ID_MOZO desc";
           ...
           // var_dump($resultado);
            while ($datos = mysqli_fetch_array($resultado)) {
                ...
                echo ' <a id="boton1" class="mbri-trash mbr-iconfont-btn" href="baja_mozo.php?ID_MOZO='.$id.'"title="borrar
                 mozo" onClick="confirm("borrar el mozo?")">
                ...
                echo '<a id="boton2" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="modificar_mozo1.php?ID_MOZO='.$id.'"
