...
<body>
    ...
    ?>
    <section>
    <button><a href="alta_orden1.html">Crear Orden </a></button>
    </section>
    <table>
        ...
        <tbody>
            ...
            $sql = "SELECT * from ORDENES_DE_PEDIDOS order by ID_ORDENES_DE_PEDIDOS desc";
            $resultado = mysqli_query($conexion,$sql);
            //var_dump($resultado);
            while ($datos = mysqli_fetch_array($resultado)) {
                $id = $datos['ID_ORDENES_DE_PEDIDOS'];
                $FECHA = $datos['FECHA_Y_HORA'];
                echo "<tr>";
                echo "<td>";
                echo $id;
                echo "</td>";
                ...
                echo ' <a id="boton1" class="mbri-trash mbr-iconfont-btn" href="baja_orden.php?ID_ORDENES_DE_PEDIDOS='.$id.'"title="borrar
                 orden" onClick="confirm("borrar la orden?")">
                ...
                echo '<a id="boton2" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="modificar_orden1.php?ID_ORDENES_DE_PEDIDOS='.$id.'"
